      ...
      >
        ...
        <div className="glass-strong rounded-2xl p-8 shadow-3d-lg">
          {!sent ? (
            <>
              <div className="mb-6">
                <h1 className="font-display text-2xl font-semibold text-text">Resend verification</h1>
            ...
            <div className="text-center py-4">
              ...
              <p className="text-sm text-text-secondary mb-6">
                If <span className="text-text font-medium">{email}</span> is registered and unverified,
