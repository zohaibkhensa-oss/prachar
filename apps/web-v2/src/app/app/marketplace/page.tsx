...
export default function MarketplacePage() {
  return (
    <div className="p-4 lg:p-8 max-w-[1600px] mx-auto animate-fade-in space-y-6">
      <LabsBanner
        title="Marketplace"
        description="Extend CURV AI with integrations and add-ons."
      ...
      <ComingSoon
        ...
        description="A curated marketplace of integrations, templates, plugins, and AI models to extend CURV AI's capabilities. Connect new channels, install creative tools, and supercharge your workflow — all in one place."
        features={[
